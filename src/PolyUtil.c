/*      $Id: PolyUtil.c 71 2010-05-07 10:13:45Z jraedler $    */
#include "PolyUtil.h"
#include <math.h>
#include <string.h>
#include <stdlib.h>
...
//   double area;
//   nv = vl->num_vertices;
//   /* do not use last point on closed contours */
...
/* other approach to setermine the orientation of a contour
   contributed by Jan Nabbefeld, based on:
